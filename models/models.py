...
if __name__ == "__main__":
    ...
    print(tensor.shape)  # torch.Size([1, 3, 1080, 1080])

    output = encoder(tensor)
    print(output.shape)  # torch.Size([1, 14, 14, 2048])
    ...
    # Todo: not working
    encoder_out = torch.rand(1, 14, 14, 2028)
    encoded_captions = torch.randint(1, 20000, (1, 128))
    caption_lengths = torch.tensor([[128]])

    output = decoder(encoder_out, encoded_captions, caption_lengths)
